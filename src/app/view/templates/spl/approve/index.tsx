...
export const buildApproveSplvalue = (
...
type ApproveSplPluginProps = {
  daoAddress: string
}

const ApproveSplPlugin = ({ daoAddress = '' }: ApproveSplPluginProps) => {
  ...
  const confirm = useCallback(async () => {
    ...
    await dispatch(setTemplateName(Templates.SPL_APPROVE))
    ...
    <Row gutter={[24, 24]}>
      <Col span={24}>
        <Space direction="vertical" size={4} style={{ width: '100%' }}>
          <Typography.Text type="secondary">Approve</Typography.Text>
          <NumericInput
